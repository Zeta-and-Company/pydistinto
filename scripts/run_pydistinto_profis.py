...
corpus = r"C:\Workstation\Trier\roman20\start_corpus\data\corpus"
workdir = r"C:\Workstation\Trier\roman20\start_corpus"
dtmfolder = join(workdir, "output", corpus, "dtms", "")

# It is recommended to name your files and folders accordingly
datadir = join(workdir, "data")#join(workdir, "data", corpus, "")
...
taggedfolder = join(outputdir, "tagged", "")#tagged, lemma_trigrams
...
segmentlength = 5000
max_num_segments = -1
featuretype = ["lemmata", "all"] # forms, lemmatapos, pos: ["all", "ADJ", "NOM", 'VER']
...
separator = "\t"
contrast = ["scifi", "ja", "nein"] # example for roman20 [blanche, policier, scifi, sentimental]
...
numfeatures = 25
measures = ["rrf_dr0", "zeta_sd0", "ranksum"]
...
numfeatures = 500
measure = "zeta_sd0" # origzeta|logzeta|ratiorelfreqs|etc.
cutoff = 0.2
